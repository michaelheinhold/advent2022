...
function parseData(set1, set2) {
  ...
  determineCompleteOverlaps(spreadSet1, spreadSet2, splitSet1, splitSet2)
  determineOverlaps(spreadSet1, spreadSet2, splitSet1, splitSet2)
}

// PART 1
function determineCompleteOverlaps(spreadSet1, spreadSet2, splitSet1, splitSet2) {
...
// PART 2
function determineOverlaps(spreadSet1, spreadSet2, splitSet1, splitSet2) {
